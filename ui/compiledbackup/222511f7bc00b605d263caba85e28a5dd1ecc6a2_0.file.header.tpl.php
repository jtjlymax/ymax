<?php
/* Smarty version 4.3.1, created on 2024-08-17 21:43:10
  from 'C:\xampp\htdocs\ymax\ui\themes\nova\sections\header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66c0a8ee6a3637_94502339',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '222511f7bc00b605d263caba85e28a5dd1ecc6a2' => 
    array (
...
function content_66c0a8ee6a3637_94502339 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
...
map/customer">
                ...
                <li class="<?php if ($_smarty_tpl->tpl_vars['_system_menu']->value == 'prepaid') {?>active<?php }?> treeview">
                    ...
                    <ul class="treeview-menu">
                        <li <?php if ($_smarty_tpl->tpl_vars['_routes']->value[1] == 'list') {?>class="active" <?php }?>>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/list"><?php echo Lang::T('Prepaid Users');?>
</a>
                        </li>
                        <li <?php if ($_smarty_tpl->tpl_vars['_routes']->value[1] == 'list') {?>class="active" <?php }?>>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
pool/list"><?php echo Lang::T('IP Pool');?>
                        ...
                        <li <?php if ($_smarty_tpl->tpl_vars['_routes']->value[1] == 'routers') {?>class="active" <?php }?>>
    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
