...
<div class="space-y-5">
  ...
  <div class="flex justify-between flex-wrap items-center mb-6">
    ...
    <div class="flex sm:space-x-4 space-x-2 sm:justify-end items-center rtl:space-x-reverse"> {if $_c['disable_voucher'] != 'yes'} 
      <!-- <button class="btn inline-flex justify-center btn-outline-success rounded-[25px] btn-sm m-1 active" data-bs-toggle="modal" data-bs-target=""> -->
        <!-- <span class="flex items-center">
          <!-- <iconify-icon class="text-xl ltr:mr-2 rtl:ml-2" icon="heroicons-outline:credit-card"></iconify-icon> -->
          <!-- <span>Redeem Voucher</span> -->
        <!-- </span> --> 
      <!-- </button> -->
       {/if} {if $_c['enable_balance'] == 'yes' && $_c['allow_balance_transfer'] == 'yes'} 
      <button class="btn inline-flex justify-center btn-outline-warning rounded-[25px] btn-sm m-1 active" data-bs-toggle="modal" data-bs-target="#transfer_modal">
        <span class="flex items-center">
