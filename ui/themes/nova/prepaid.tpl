                            ...
                            {foreach $d as $ds}
                                <tr {if $ds['status']=='off'}class="danger" {/if}>
                                    ...
                                    <td>
                                        ...
                                        {if in_array($_admin['user_type'],['SuperAdmin','Admin'])}
                                            <a href="{$_url}prepaid/enable/{$ds['id']}" id="{$ds['id']}" onclick="return confirm('{Lang::T('Enable')}?')" class="btn btn-primary btn-xs">{Lang::T('Enables')}</a>
                                            <a href="{$_url}prepaid/disable/{$ds['id']}" id="{$ds['id']}" onclick="return confirm('{Lang::T('Disable')}?')" class="btn btn-warning btn-xs">{Lang::T('Disables')}</a>
